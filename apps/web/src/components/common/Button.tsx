...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    primary:
      "bg-accent-orange text-white hover:bg-orange-600 active:bg-orange-700",
    secondary:
      "bg-cream-card text-ink-primary hover:bg-white active:bg-cream-muted",
    ...
    ghost:
      "bg-transparent border-transparent shadow-none hover:bg-cream-muted hover:border-ink-primary hover:shadow-neo-sm active:translate-y-0.5",
  }[variant];
